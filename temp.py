...
INPUTS_DIR = Path('/kaggle/input/israelishekels-1-2-5-10/CoinCount.v52i.yolov5pytorch')
...
# --- Model Configuration ---
MODEL_NAME_FOR_TRAINING = '/kaggle/working/IsraeliCoinsCount/BestModels/yolov8n_v2.pt'
MODEL_PATH_FOR_PREDICTION = '/kaggle/working/IsraeliCoinsCount/BestModels/yolov8n_v2.pt'
